...
│       ├── layout_pcb_amplifier_2sk2974.png    # Базовая топология печатной платы усилителя в AWR MWO
│       ├── layout_pcb_smd_amplifier_2sk2974.png # Детализированная топология с контактными площадками SMD
...
<p align="center">
  <img src="docs/images/layout_pcb_amplifier_2sk2974.png" alt="Базовая топология платы" width="48%"/>
  <img src="docs/images/layout_pcb_smd_amplifier_2sk2974.png" alt="Детализированная топология платы с SMD" width="48%"/>
  <br>
  <em>Рисунок 4 — Топология печатной платы в AWR MWO: базовая компоновка (слева) и детальная топология с контактными площадками SMD-компонентов (справа)</em>
</p>
...
<p align="center">
  <img src="docs/images/plot_smd_vswr_frequency_response.png" alt="КСВН схемы на SMD-компонентах" width="48%"/>
  <img src="docs/images/plot_smd_s21_gain.png" alt="Усиление схемы на SMD-компонентах" width="48%"/>
  <br>
  <em>Рисунок 11 — Характеристики усилителя на реальных SMD-компонентах в диапазоне 0.5–1.5 ГГц: КСВН (слева) и усиление |S21| (справа)</em>
</p>
