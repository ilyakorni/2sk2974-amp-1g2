...
│       ├── schematic_smd_amplifier_2sk2974.png # Полная схема усилителя на SMD-компонентах с меандрами смещения
...
<p align="center">
  <img src="docs/images/schematic_smd_amplifier_2sk2974.png" alt="Схема усилителя на реальных SMD-компонентах с меандровыми цепями питания" width="900"/>
  <br>
  <em>Рисунок 3 — Принципиальная схема усилителя на SMD-компонентах с четвертьволновыми меандровыми цепями подачи смещения</em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Рисунок 4 — Двумерная топология платы в AWR Microwave Office: измерение габаритной ширины (32.38 мм)</em>
</p>

<p align="center">
  <img src="docs/images/layout_pcb_smd_2d_dimension_y.png" alt="Топология печатной платы с габаритом по высоте" width="850"/>
  <br>
  <em>Рисунок 5 — Двумерная топология платы в AWR Microwave Office: измерение габаритной высоты (24.12 мм)</em>
</p>

<p align="center">
  <img src="docs/images/layout_pcb_smd_3d_view.png" alt="3D-модель печатного узла усилителя 2SK2974" width="850"/>
  <br>
  <em>Рисунок 6 — Трехмерная модель сборки печатного узла усилителя (3D Layout View)</em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Рисунок 7 — Диаграммы Вольперта-Смита идеальной схемы: S11 (слева) и S22 (справа)</em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Рисунок 8 — Частотные зависимости |S11| (слева) и коэффициента усиления |S21| (справа) идеальной схемы</em>
</p>

<p align="center">
  <img src="docs/images/plot_vswr_frequency_response.png" alt="Частотная зависимость КСВН" width="700"/>
  <br>
  <em>Рисунок 9 — Частотная зависимость КСВН по входу идеальной схемы</em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Рисунок 10 — Диаграмма Вольперта-Смита для микрополосковой схемы: S11 (треугольник) и S22 (квадрат) на частоте 1.2 ГГц</em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Рисунок 11 — Параметры микрополоскового усилителя на частоте 1.2 ГГц: КСВН портов 1 и 2 (слева) и коэффициент усиления |S21| (справа)</em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Рисунок 12 — Диаграмма Вольперта-Смита схемы на реальных SMD-компонентах: S(1,1) и S(2,2) в полосе 1.20–1.21 ГГц</em>
</p>

<p align="center">
  <img src="docs/images/plot_smd_vswr_frequency_response.png" alt="КСВН схемы на SMD-компонентах" width="750"/>
  <br>
  <em>Рисунок 13 — Частотная зависимость КСВН усилителя на реальных SMD-компонентах в диапазоне 0.5–1.5 ГГц</em>
</p>

<p align="center">
  <img src="docs/images/plot_smd_s21_gain.png" alt="Усиление схемы на SMD-компонентах" width="750"/>
  <br>
  <em>Рисунок 14 — Частотная зависимость коэффициента передачи |S21| (усиления) в диапазоне 0.5–1.5 ГГц</em>
</p>
